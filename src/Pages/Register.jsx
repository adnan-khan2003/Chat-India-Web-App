    ...
    <div className="formContainer">
      <div className="formWrapper">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label htmlFor="file">
            <img src={images} alt="" />
            <span className="loginorsignup"> Add an avatar</span>
          </label>
      ...
      <div className="formWrapper">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label htmlFor="file">
            <img src={images} alt="" />
            <span
            className="loginorsignup"> Add an avatar</span>
          </label>
          <button disabled={loading}>Sign up</button>
          {loading && <p>Uploading and compressing<br/>the image please wait...</p>}
          {err && <span
